				...
				while ( $zeventsloop->have_posts() ) : $zeventsloop->the_post(); 
					...
					<div class="row  vcenter">
	    				<div class="col-md-3 col-sm-5 col-xs-12">
	    					<h1 id="title"><?php echo $dateUse->format('m/d'); ?></h1>
	    				</div>
...
<script>
//making sure that the height of the home screen is as tall as the window size on desktop computers
...
<div class="container-fluid socback">
    ...
    <?php /** FB FEED taken out at the request of Jon Zorn ?>
<div class="col-sm-6"> 
<div class="aligncenter">
